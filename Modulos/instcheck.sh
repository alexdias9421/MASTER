...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/alexdias9421/MASTER/main/Modulos/checkuser.py > /dev/null 2>&1
